...
def get_unique_chess_genes():
	...
	chess_hugo_filepath="Data/hgnc-symbol-check_chess3.1.3_GRCh38_assembly_proteincoding.csv"
	ensembl_hugo_filepath="Data/hgnc-symbol-check-ensembl113_GRCh38_assembly_proteincoding.csv"
	ncbi_hugo_filepath="Data/hgnc-symbol-check_NCBI_2024_assembly_proteincoding.csv"
	...
	ncbi_unique_genes.to_csv("Data/refseq_2024_08_not_ensembl_133_genes_proteincoding_assembly.csv",index=False,header=False)
...
def get_chess_coordinates(CHESS3_unique_genes):
	...
	chess_bed_file= pd.read_csv("Data/chess3.1.3.GRCh38.assembly.bed",delimiter="\t",header=None)
	...
	unique_proteincoding_bed[['global_exon_ranges']].to_csv("Data/CHESS3.1.3_unique_protein_coding_genes_coordinates.csv",header=False,index=False)

	#associate each exon range with CHESS identifier to associate guides back after CRISPick run
	unique_proteincoding_bed[[12,'global_exon_ranges']].to_csv("Data/CHESS3.1.3_unique_protein_coding_genes_coordinates_with_identifier.csv",header=False,index=False)
